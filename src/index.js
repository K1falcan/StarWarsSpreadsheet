...
const LEVELS = [
  ...
  {level:3,title:"Jedi Knight", xpNeeded:150, color:"#66BB6A"},
  {level:4,title:"Jedi Master", xpNeeded:300, color:"#FFD700"},
  {level:5,title:"Jedi Council",xpNeeded:500, color:"#AB47BC"},
...
function logout(){
  saveStats();
  player=null;
  state={xp:0,streak:0,bestStreak:0,totalCorrect:0,totalWrong:0,roundsPlayed:0,roundNum:0,usedIds:[],questions:[],qIndex:0,answers:[],roundScore:0,leveledUp:false,prevLevel:null,_lastChosen:-1};
...
async function startRound(){
  ...
  state.questions=qs;state.qIndex=0;state.answers=new Array(qs.length).fill(null);
  state.roundScore=0;state.roundNum++;state.leveledUp=false;
